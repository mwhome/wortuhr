...
void handleRoot()
{
	...
	message += "<br><i class=\"fa fa-thermometer\" style=\"font-size:20px;\"></i> " + String(roomTemperature) + "&deg;C ";
#endif
#ifdef SENSOR_DHT22
	...
	message += "<br><br><i class = \"fa fa-tree\" style=\"font-size:20px;\"></i>"
		"<br><i class = \"fa fa-thermometer\" style=\"font-size:20px;\"></i> " + String(outdoorWeather.temperature) + "&deg;C "
		"<br><i class = \"fa fa-tint\" style=\"font-size:20px;\"></i> " + String(outdoorWeather.humidity) + "% relative Luftfeuchtigkeit";
	message += "<br>" + outdoorWeather.description;
#endif
	message += "<span style=\"font-size:12px;\">"
		"<br><br><a href=\"http://tmw-it.ch/qlockwork/\">Qlockwork</a> was <i class=\"fa fa-code\"></i> with <i class=\"fa fa-heart\"></i> by ch570512 and Weber"
