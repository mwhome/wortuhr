...
typedef struct layout_s {
  uint8_t matrix[NUMPIXELS_Y * NUMPIXELS_X];
  uint8_t corners[NUMPIXELS_CORNERS];
  uint8_t alarm;
...
#ifdef LED_LAYOUT_VERTICAL_4_XXL
    const layout_t ledMap = {
      {
          10, 12,  31,  32,  51,  52,  71,  72,  91,  92, 112,
          9,  13,  30,  33,  50,  53,  70,  73,  90,  93, 111,
